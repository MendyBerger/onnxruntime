...
// use crate::cosmonic::onnx_runtime::types::{TensorValueType, Value};
...
// impl From<Bits> for crate::cosmonic::onnx_runtime::types::Value<TensorValueType<f32>> {
impl From<Bits> for crate::cosmonic::onnx_runtime::types::Tensor {
